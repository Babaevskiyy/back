            ...
            <div className="flex-1 flex flex-col items-center justify-center bg-gray-100">
                {!isDirectoryCreated ? (
                    <div className="text-center p-6 bg-white rounded-lg shadow-md w-full max-w-sm">
                        <h1 className="text-2xl font-semibold mb-4">Создать или выбрать справочник</h1>
                        <p className="text-gray-600 mb-6">
                            Чтобы продолжить, выберите существующий справочник или создайте новый.
                        </p>
                        <div className="flex flex-col gap-4">
                            <button
                                className="w-full px-6 py-3 bg-blue-500 text-white rounded-md shadow-md hover:bg-blue-600"
                                onClick={() => setIsSelectModalOpen(true)}
                            >
                                Выбрать существующий
                            </button>
                            <button
                                className="w-full px-6 py-3 bg-green-500 text-white rounded-md shadow-md hover:bg-green-600"
                ...
                {/* Модальное окно для выбора справочника */}
                {isSelectModalOpen && (
                    <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
                        <div className="bg-white p-6 rounded-lg shadow-lg w-96">
                            <h2 className="text-lg font-semibold mb-4">Выберите существующий справочник</h2>
                ...
                {/* Модальное окно для создания справочника */}
                {isCreateModalOpen && (
                    <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
                        <div className="bg-white p-6 rounded-lg shadow-lg w-96">
                            <h2 className="text-lg font-semibold mb-4">Создать новый справочник</h2>
                            <input
                                type="text"
